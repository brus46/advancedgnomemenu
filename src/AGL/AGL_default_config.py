...
class conf:
    ...
    def rewrite(self):
        ...
        if file!=None:
            ...
            file.write("applet_icon_pressed="+self.applet_icon_pressed+"\n")
            if self.use_applet_icon_pressed: file.write("use_applet_icon_pressed=True"+"\n")
            else: file.write("use_applet_icon_pressed=False"+"\n")
