...
try:
    ...
    gconf_exist=False
    import AGM_default_config_from_file
    conf=AGM_default_config_from_file.conf
    gradient_direction=AGM_default_config_from_file.gradient_direction
    popup_style=AGM_default_config_from_file.popup_style
    positions=AGM_default_config_from_file.positions
    top_position=AGM_default_config_from_file.top_position
                ...
                for line in file.readlines():
                    ...
                    if len(data)>=2:
                        ...
                        if data[0]=="opacity":
                            ...
                            print "command_on_logo_clicked is deprecated"
